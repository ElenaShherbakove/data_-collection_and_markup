...
- Отфильтруйте документы по критерию "properties.fatalities", равному "Yes", 
и подсчитайте количество совпадающих документов.
- Используйте проекцию для отображения только полей "properties.lightcond" 
и "properties.weather" для документов с "properties.fatalities" равным "Yes".'''
...
- Используйте оператор $in для подсчета количества документов, в которых "properties.rdclass" 
является либо "US ROUTE", либо "STATE SECONDARY ROUTE".
